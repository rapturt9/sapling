...
////////////////////////////////////////////////
const maxDelay = 100000000000000;
/*const frac = 0.2;
const nTrees = 1;*/
let frac = window.frac;
let nTrees = window.nTrees;
  ...
  for (var i = 0; i < mesh.children.length; i++) {
    ...
    if (child.userData.refClass && child.userData.refClass.type == "foliage") {
      ...
      TweenMax.from(child.scale, s, {
        ...
        y: 0.01,
        z: 0.01,
        delay: i < mesh.children.length * frac ? d : maxDelay,
        ease: Back.easeInOut,
      });
